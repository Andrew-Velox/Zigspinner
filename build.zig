...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("Zigspinner", .{
    ...
    const exe = b.addExecutable(.{
        ...
        .root_module = b.createModule(.{
            ...
            // root module.
            .imports = &.{
                // Here "Zigspinner" is the name you will use in your source code to
                // import this module (e.g. `@import("Zigspinner")`). The name is
    ...
    const no_std_example = b.addExecutable(.{
        .name = "example-no-std",
        .root_module = b.createModule(.{
            .root_source_file = b.path("examples/no_std.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "Zigspinner", .module = mod },
    ...
    const run_no_std_step = b.step("run-no-std", "Run no-std style example");
    const run_no_std_cmd = b.addRunArtifact(no_std_example);
    run_no_std_step.dependOn(&run_no_std_cmd.step);
